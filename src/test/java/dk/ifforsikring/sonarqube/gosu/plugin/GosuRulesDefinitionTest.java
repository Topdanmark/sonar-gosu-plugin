...
import dk.ifforsikring.test.support.SonarServerVersionSupported;
...
class GosuRulesDefinitionTest {
    ...
    void shouldLoadMetadataDefinitionForAllChecks(SonarServerVersionSupported sonarServerVersion) {
        // given
        final SonarRuntime sonarRuntime = SonarRuntimeImpl.forSonarQube(sonarServerVersion.getVersion(),
        ...
        assertThat(repository.name()).isNotNull().isEqualTo("Sonar");
